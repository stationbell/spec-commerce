...
Humans and agents working together to turn building and product specifications into bill-of-materials transactions online.
...
ChatGPT in Work mode on the left. Our product page on the right, with the Spec check panel answering from product data: the 11 lb unit does not meet section 2.3, the 15.5 lb unit does with the recessed cabinet that fits it shown as well.
...
**Live demo:** Open it in the ChatGPT desktop app's browser with the chat in Work mode, or in Chrome 149 or newer with `chrome://flags/#enable-webmcp-testing` turned on. The demo page at https://spec-commerce.stationbell.com mirrors our real product page: https://usmadesupply.com/safety/fire-extinguishers/halotron/usms-marketplace/products/buckeye-11-lb-halotron-clean-agent-fire-extinguisher?spec-commerce
